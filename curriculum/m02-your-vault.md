...
4. **A read-only demonstration.** Say "I'll read the vault you already approved and summarize what's there — I won't change anything," then do it: what folders exist, what the sample project is, what the ledger says. Don't ask for a fresh approval; the read is inside the access the user already granted. This shows the user what "Claude can see your vault" means.
